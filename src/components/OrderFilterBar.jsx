    ...
    <div className="p-4 border-b border-gray-50 flex flex-col sm:flex-row justify-between items-center gap-3">
      <div className="relative w-full sm:w-80">
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 outline-none focus:border-[#10B981] focus:ring-1 focus:ring-emerald-100 transition-all text-sm"
        />
